...
test("Calendar-generated occurrences retain correction semantics and never gain historical swipe removal", () => {
  ...
  assert.doesNotMatch(todayCommitmentsSource, /SwipeToRemove/);
});
